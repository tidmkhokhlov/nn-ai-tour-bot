...
SPECIAL_COMPOUND_RULES: List[Dict[str, object]] = [
    {
        "all_keywords": ["военн"],
        "any_keywords": ["техник", "музей", "оруж"],
        "category": "history",
        "queries": ["музей военной техники", "военный музей"],
    },
    {
        "all_keywords": ["архитектур", "век"],
        "any_keywords": ["конструктивизм", "советск", "модерн"],
        "category": "art",
        "queries": ["архитектура XX века", "конструктивизм"],
    },
]
...
# Системный промпт для GPT (можно вынести в отдельный файл/шаблон)
